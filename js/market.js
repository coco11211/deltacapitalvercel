...
(function () {
  ...
  // --- Stock Universe ---
  // Updated to realistic February 2026 prices
  var STOCKS = [
    { symbol: 'SPY', name: 'S&P 500 ETF', price: 585.45, sector: 'Index', cap: '—', vol: 0.012 },
    { symbol: 'QQQ', name: 'Nasdaq 100 ETF', price: 520.30, sector: 'Index', cap: '—', vol: 0.014 },
    { symbol: 'DIA', name: 'Dow Jones ETF', price: 445.80, sector: 'Index', cap: '—', vol: 0.010 },
    { symbol: 'IWM', name: 'Russell 2000 ETF', price: 235.60, sector: 'Index', cap: '—', vol: 0.016 },
    { symbol: 'AAPL', name: 'Apple Inc', price: 220.40, sector: 'Technology', cap: '3.42T', vol: 0.015 },
    { symbol: 'MSFT', name: 'Microsoft Corp', price: 450.25, sector: 'Technology', cap: '3.38T', vol: 0.014 },
    { symbol: 'GOOGL', name: 'Alphabet Inc', price: 195.80, sector: 'Technology', cap: '2.42T', vol: 0.016 },
    { symbol: 'AMZN', name: 'Amazon.com Inc', price: 210.65, sector: 'Technology', cap: '2.18T', vol: 0.017 },
    { symbol: 'NVDA', name: 'NVIDIA Corp', price: 950.20, sector: 'Technology', cap: '2.35T', vol: 0.025 },
    { symbol: 'META', name: 'Meta Platforms', price: 600.40, sector: 'Technology', cap: '1.58T', vol: 0.020 },
    { symbol: 'TSLA', name: 'Tesla Inc', price: 320.15, sector: 'Technology', cap: '1.02T', vol: 0.030 },
    { symbol: 'JPM', name: 'JPMorgan Chase', price: 225.30, sector: 'Financials', cap: '658B', vol: 0.013 },
    { symbol: 'V', name: 'Visa Inc', price: 310.45, sector: 'Financials', cap: '638B', vol: 0.012 },
    { symbol: 'GS', name: 'Goldman Sachs', price: 455.20, sector: 'Financials', cap: '165B', vol: 0.016 },
    { symbol: 'MA', name: 'Mastercard Inc', price: 495.60, sector: 'Financials', cap: '478B', vol: 0.012 },
    { symbol: 'BAC', name: 'Bank of America', price: 41.85, sector: 'Financials', cap: '335B', vol: 0.015 },
    { symbol: 'BRK.B', name: 'Berkshire Hathaway', price: 445.75, sector: 'Financials', cap: '925B', vol: 0.010 },
    { symbol: 'UNH', name: 'UnitedHealth Group', price: 580.50, sector: 'Healthcare', cap: '545B', vol: 0.013 },
    { symbol: 'JNJ', name: 'Johnson & Johnson', price: 172.40, sector: 'Healthcare', cap: '415B', vol: 0.010 },
    { symbol: 'PFE', name: 'Pfizer Inc', price: 32.15, sector: 'Healthcare', cap: '185B', vol: 0.014 },
    { symbol: 'ABBV', name: 'AbbVie Inc', price: 195.80, sector: 'Healthcare', cap: '358B', vol: 0.013 },
    { symbol: 'XOM', name: 'Exxon Mobil Corp', price: 125.40, sector: 'Energy', cap: '528B', vol: 0.014 },
    { symbol: 'CVX', name: 'Chevron Corp', price: 170.25, sector: 'Energy', cap: '325B', vol: 0.013 },
    { symbol: 'WMT', name: 'Walmart Inc', price: 192.30, sector: 'Consumer', cap: '521B', vol: 0.011 },
    { symbol: 'KO', name: 'Coca-Cola Co', price: 68.45, sector: 'Consumer', cap: '295B', vol: 0.009 },
    { symbol: 'PG', name: 'Procter & Gamble', price: 180.15, sector: 'Consumer', cap: '425B', vol: 0.009 },
    { symbol: 'DIS', name: 'Walt Disney Co', price: 115.20, sector: 'Consumer', cap: '210B', vol: 0.018 },
    { symbol: 'NFLX', name: 'Netflix Inc', price: 750.40, sector: 'Technology', cap: '325B', vol: 0.022 },
    { symbol: 'AMD', name: 'Advanced Micro Devices', price: 185.60, sector: 'Technology', cap: '305B', vol: 0.024 },
    { symbol: 'CRM', name: 'Salesforce Inc', price: 305.20, sector: 'Technology', cap: '298B', vol: 0.018 }
  ];
